...
Arguments [defaults] -> Can be abbreviated to shortest unambiguous prefixes
    ...
    required.add_argument('--insample', metavar = "Input File", dest = "insample", help = 'Sample result file (.csv - the cohort should match the trained model cohort, else you might get incorrect predictions!!!) for which you want to score the variants', required=True)
