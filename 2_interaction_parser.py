...
def SecAC(inSecAC):
    ...
    Secondary_AC_file = open(inSecAC)
...
def interaction_parser(args):
    ...
    Primary_AC_dict = PrimAC(args.inPrimAC)
    Secondary_AC_dict = SecAC(args.inSecAC)
    GeneID_dict = GeneID(args.inSecAC)
