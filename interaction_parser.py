...
def main():
    ...
    required.add_argument('-i1', '--input1',  dest = "input1", help = 'Input File Name (Protein-protein Interaction file)', required = True)
    required.add_argument('-i2', '--input2',  dest = "input2", help = 'Uniprot Primary Accession File generated by the uniprot parser', required = True)
    required.add_argument('-i3', '--input3',  dest = "input3", help = 'Secondary Accession File generated by the uniprot parser', required = True)
    required.add_argument('-i4', '--input4',  dest = "input4", help = 'GeneID File generated by the uniprot parser', required = True)
