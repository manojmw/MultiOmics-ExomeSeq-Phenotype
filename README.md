...
- Parses the Sample metadata file (.xlsx), UniProt Primary Accession file (Ex:uniprot_main.tsv), Canonical transcripts file (Ex: canonicalTranscripts_220221.tsv), Candidate Gene file(s) (Ex: candidateGenes.xlsx) & Interactome file generated by `4_BuildInteractome.py`
...
```console
python3 7_Score1ML_candidateGenes.py --inSampleFile sample.xlsx --inPrimAC uniprot_main.tsv --inCandidateFile candidateGenes.xlsx --inCanonicalFile canonicalTranscripts_220221.tsv --inInteractome Interactome_human.tsv
```                      
