...
**For detailed description on the output generated by the scripts, please use the --help, -h option. You can also view sample output files in the Sample_Output_Files/ directory in the repo**
