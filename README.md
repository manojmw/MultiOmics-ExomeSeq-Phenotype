...
**Note: The Machine learning scripts are used for variant prioritization, and can be used only on the result files generated by the [pipeline](https://github.com/manojmw/grexome-TIMC-Secondary)**.
